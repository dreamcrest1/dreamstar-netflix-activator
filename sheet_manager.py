...
DEFAULT_SHEET_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vStnad3krD7KOQH9j-rdByDMzuvHzwWDyRI8fuH0fAblp_tBPM3REPSATK7Z6UbWo4yViSD-H6FUgm7/pub?gid=0&single=true&output=csv"
...
def fetch_and_validate_user(mobile_number: str, custom_sheet_url: str = None):
    ...
    if is_number_blocked(clean_mobile):
        return {
            ...
            "message": f"Mobile '{clean_mobile}' is blocked. Contact Dreamstar Support on WhatsApp."
        }
    ...
    try:
        ...
        if res.status_code != 200:
            return {
                ...
                "message": f"Unable to reach records spreadsheet (HTTP {res.status_code})."
            }
        ...
        if not reader:
            return {
                ...
                "message": "Database sheet contains no records."
            }
        ...
        if matched_row is None:
            return {
                ...
                "message": f"Mobile '{clean_mobile}' is not registered with Dreamstar Solutions."
            }
        ...
        if expiry_dt:
            ...
            if current_dt > expiry_end_of_day:
                return {
                    ...
                    "message": f"Your plan expired on {formatted_display_expiry}. Contact Dreamstar to renew.",
        ...
        return {
            ...
            "expiry_date": formatted_display_expiry,
            "message": "Subscription active and verified."
        }
