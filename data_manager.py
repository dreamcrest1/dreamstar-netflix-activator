...
DEFAULT_SETTINGS = {
    ...
    "whatsapp_number": "+91 99914 83279",
    "whatsapp_link": "https://wa.me/919991483279?text=Hi%20Dreamstar%20Solutions%2C%20I%20need%20help%20with%20my%20TV%20Activation",
    "custom_sheet_url": "https://docs.google.com/spreadsheets/d/e/2PACX-1vStnad3krD7KOQH9j-rdByDMzuvHzwWDyRI8fuH0fAblp_tBPM3REPSATK7Z6UbWo4yViSD-H6FUgm7/pub?gid=0&single=true&output=csv"
}
...
def log_activation_detail(mobile: str, email: str, code: str, success: bool, message: str, steps: list):
    ...
    data["debug_logs"] = data["debug_logs"][:500]
    save_app_data(data)
    return detail_entry
...
def check_activation_limit(mobile: str):
    if is_number_blocked(mobile):
        return False, "This mobile number has been suspended. Contact Dreamstar Support on WhatsApp."
    ...
    if max_monthly > 0 and monthly_count >= max_monthly:
        return False, f"Monthly activation limit reached ({monthly_count}/{max_monthly} used this month). Contact WhatsApp support."

    if max_total > 0 and total_count >= max_total:
        return False, f"Total activation limit reached ({total_count}/{max_total} used). Contact WhatsApp support."
